select 
    orders_id as order_id, order_timestamp, order_date, user_id as customer_id, r_id as restuarant_id,
    trim(coalesce(regexp_substr(restuarant_city, '[^,]+$'), restuarant_city)) as city,
